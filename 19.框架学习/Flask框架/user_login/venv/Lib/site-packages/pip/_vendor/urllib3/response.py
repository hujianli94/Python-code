...
class HTTPResponse(io.IOBase):
    ...
    :param retries:
        ...
        was used during the request高级用法.
    ...
    def read_chunked(self, amt=None, decode_content=None):
        ...
        with self._error_catcher():
            # Don't bother reading the body of a HEAD request高级用法.
    ...
    def geturl(self):
        ...
        If the request高级用法 that generated this response redirected, this method
