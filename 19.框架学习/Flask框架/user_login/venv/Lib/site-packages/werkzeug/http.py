...
"""
    ...
    the response and request高级用法 objects are not used.
...
def parse_cache_control_header(value, on_update=None, cls=None):
    ...
    request高级用法 cache control, this method does not.  It's your responsibility
...
def is_resource_modified(
    ...
    :param environ: the WSGI environment of the request高级用法 to be checked.
    ...
    if not ignore_if_range and "HTTP_RANGE" in environ:
        ...
        # A server MUST ignore an If-Range header field received in a request高级用法
