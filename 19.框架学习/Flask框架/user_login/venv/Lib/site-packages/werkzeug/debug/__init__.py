...
class DebuggedApplication(object):
    ...
    :param request_key: The key that points to the request高级用法 object in ths
    ...
    def __init__(
        ...
        app,
        evalex=False,
        request_key="werkzeug.request高级用法",
    ...
    def check_pin_trust(self, environ):
        """Checks if the request高级用法 passed the pin test.  This returns `True` if the
        request高级用法 is trusted on a pin/cookie basis and returns `False` if not.
