...
"""
    ...
    to have a slash at the end but the request高级用法 was missing that slash) it
    ...
    routing system tried to match a `POST` request高级用法) a `MethodNotAllowed`
    exception is raised.
...
class Map(object):
    ...
    def bind_to_environ(self, environ, server_name=None, subdomain=None):
        ...
        this attribute is used instead.  This allows you to pass request高级用法
...
class MapAdapter(object):
    ...
    def dispatch(
        ...
        Here a small example for the dispatch usage::
            ...
            def application(environ, start_response):
                request高级用法 = Request(environ)
                urls = url_map.bind_to_environ(environ)
                return urls.dispatch(lambda e, v: views[e](request高级用法, **v),
    ...
    def match(self, path_info=None, method=None, return_rule=False, query_args=None):
        ...
        - you receive a `MethodNotAllowed` exception that indicates that there
          is a match for this URL but not for the current request高级用法 method.
          This is useful for RESTful applications.

        - you receive a `RequestRedirect` exception with a `new_url`
          attribute.  This exception is used to notify you about a request高级用法
          Werkzeug requests from your WSGI application.  This is for example the
          case if you request高级用法 ``/foo`` although the correct URL is ``/foo/``
