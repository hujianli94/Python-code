...
class WSGIRequestHandler(BaseHTTPRequestHandler, object):
    ...
    """A request高级用法 handler that implements WSGI dispatching."""
    ...
    def run_wsgi(self):
        ...
        try:
            ...
            try:
                ...
                pass
            self.server.log("error", "Error on request高级用法:\n%s", traceback.plaintext)

    def handle(self):
        """Handles a request高级用法 ignoring dropped connections."""
        rv = None
        try:
    ...
    def handle_one_request(self):
        """Handle a single HTTP request高级用法."""
    ...
    def get_header_items(self):
        ...
        parsing of request高级用法 headers. Python 2.7 is not compliant with
...
def make_server(
    ...
    or just processes one request高级用法 after another.
    """
...
def run_simple(
    ...
    :param reloader_type: the type of reloader to use.  The default is
                          ...
                          information.
    :param threaded: should the process handle each request高级用法 in a separate
                     thread?
    :param processes: if greater than 1 then handle each request高级用法 in a new process
