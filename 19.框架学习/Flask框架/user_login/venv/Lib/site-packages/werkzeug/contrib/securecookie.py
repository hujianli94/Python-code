...
r"""
    ...
    If you are using the werkzeug request高级用法 objects you could integrate the
    secure cookie into your application like this::
        ...
        def application(environ, start_response):
            ...
            if request高级用法.client_session.should_save:
                session_data = request高级用法.client_session.serialize()
    ...
    A less verbose integration can be achieved by using shorthand methods::
        ...
        def application(environ, start_response):
            ...
            request高级用法.client_session.save_cookie(response)
            return response(environ, start_response)
...
class SecureCookie(ModificationTrackingDict):
    ...
    def load_cookie(cls, request, key="session", secret_key=None):
        """Loads a :class:`SecureCookie` from a cookie in request高级用法.  If the
        cookie is not set, a new :class:`SecureCookie` instanced is
        returned.

        :param request: a request高级用法 object that has a `cookies` attribute
