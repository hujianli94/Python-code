...
class EnvironBuilder(object):
    ...
    or request高级用法 objects from arbitrary data.
    ...
    :param path: the path of the request高级用法.  In the WSGI environment this will
    ...
    :param content_type: The content type for the request高级用法.  As of 0.5 you
                         don't have to provide this when specifying files
                         and form data via `data`.
    :param content_length: The content length for the request高级用法.  You don't
    ...
    #: the default request高级用法 class for :meth:`get_request`
    ...
    content_type = property(
        _get_content_type,
        _set_content_type,
        doc="""The content type for the request高级用法.  Reflected from and to
    ...
    def get_request(self, cls=None):
        """Returns a request高级用法 with the data.  If the request高级用法 class is not
        specified :attr:`request_class` is used.

        :param cls: The request高级用法 wrapper to use.
        """
        if cls is None:
...
class Client(object):
    ...
    If you want to request高级用法 some subdomain of your application you may set
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        """Perform a new request高级用法 to the location given by the redirect
        response to the previous request高级用法.
        """
        ...
        if to_name_parts != [""]:
            ...
            # doesn't have a host, so use the request高级用法's host.
        ...
        # Only 307 and 308 preserve all of the original request高级用法.
...
def create_environ(*args, **kwargs):
    ...
    parameter should be the path of the request高级用法 which defaults to '/'.  The
    second one can either be an absolute path (in that case the host is
    localhost:80) or a full path to the request高级用法 with scheme, netloc port and
