...
class _CacheControl(UpdateDictMixin, dict):
    ...
    The class does not differentiate between request高级用法 and response directives.
...
class RequestCacheControl(ImmutableDictMixin, _CacheControl):
    ...
    to all the request高级用法-relevant cache control headers.
    ...
    .. versionadded:: 0.5
       ...
       both for request高级用法 and response.
    """
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    @property
    def stale(self):
        """A flag, indicating that the previous request高级用法 from the client
...
class FileStorage(object):
    ...
    It is used by the request高级用法 object to represent uploaded files.  All the
