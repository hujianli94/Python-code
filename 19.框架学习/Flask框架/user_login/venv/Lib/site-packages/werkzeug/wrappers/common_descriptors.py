...
class CommonRequestDescriptorsMixin(object):
    ...
    def content_length(self):
        ...
        the entity-body that would have been sent had the request高级用法 been a
        GET.
        """
    ...
    referrer = environ_property(
        "HTTP_REFERER",
        doc="""The Referer[sic] request高级用法-header field allows the client
    ...
    max_forwards = environ_property(
        ...
        None,
        int,
        doc="""The Max-Forwards request高级用法-header field provides a
        mechanism with the TRACE and OPTIONS methods to limit the number
        of proxies or gateways that can forward the request高级用法 to the next
        inbound server.""",
    )
    ...
    def pragma(self):
        ...
        along the request高级用法/response chain.  All pragma directives specify
...
class CommonResponseDescriptorsMixin(object):
    ...
    location = header_property(
        ...
        completion of the request高级用法 or identification of a new
        resource.""",
    )
    age = header_property(
        "Age",
    ...
    content_length = header_property(
        ...
        entity-body that would have been sent had the request高级用法 been a
        GET.""",
    )
    ...
    vary = _set_property(
        "Vary",
        doc="""The Vary field value indicates the set of request高级用法-header
        fields that fully determines, while the response is fresh,
        whether a cache is permitted to use the response to reply to a
        subsequent request高级用法 without revalidation.""",
    )
