...
class Request(
    ...
    """Full featured request高级用法 object implementing the following mixins:
...
class StreamOnlyMixin(object):
    """If mixed in before the request高级用法 object this will change the bahavior
...
class PlainRequest(StreamOnlyMixin, Request):
    """A request高级用法 object without special form parsing capabilities.
