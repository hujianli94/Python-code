...
class ETagRequestMixin(object):
    """Add entity tag and cache descriptors to a request高级用法 object or object with
...
class ETagResponseMixin(object):
    ...
    def make_conditional(
        ...
        """Make the response conditional to the request高级用法.  This method works
        best if an etag was defined for the response already.  The `add_etag`
        method can be used to do that.  If called without etag just the date
        header is set.

        This does nothing if the request高级用法 method in the request高级用法 or environ is
        ...
        :param request_or_environ: a request高级用法 object or WSGI environment to be
