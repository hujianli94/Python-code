...
class BaseResponse(object):
    ...
    def get_data(self, as_text=False):
        """The string representation of the request高级用法 body.  Whenever you call
        this property the request高级用法 iterable is encoded and flattened.  This
    ...
    def get_wsgi_headers(self, environ):
        ...
        :param environ: the WSGI environment of the request高级用法.
    ...
    def get_app_iter(self, environ):
        ...
        on the request高级用法 method and the current status code the return value
        might be an empty response rather than the one from the response.

        If the request高级用法 method is `HEAD` or the status code is in a range
    ...
    def get_wsgi_response(self, environ):
        ...
        specially for the given environment.  For example if the request高级用法
