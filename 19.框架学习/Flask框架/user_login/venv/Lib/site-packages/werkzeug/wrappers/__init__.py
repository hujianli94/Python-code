...
The wrappers are simple request高级用法 and response objects which you can
subclass to do whatever you want them to do.  The request高级用法 object contains
the information transmitted by the client (webbrowser) and the response
object contains all the information sent back to the browser.

An important detail is that the request高级用法 object is created with the WSGI
