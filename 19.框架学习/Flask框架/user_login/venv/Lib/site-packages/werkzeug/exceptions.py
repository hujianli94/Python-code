...
"""
    ...
    ::
        ...
        def view(request高级用法):
            raise NotFound()

        @responder
        def application(environ, start_response):
            request高级用法 = BaseRequest(environ)
            try:
                return view(request高级用法)
...
class HTTPException(Exception):
    ...
    def get_response(self, environ=None):
        ...
        :param environ: the optional environ for the request高级用法.  This
                        can be used to modify the response depending
                        on how the request高级用法 looked like.
...
class BadRequest(HTTPException):
    ...
    code = 400
    description = (
        "The browser (or proxy) sent a request高级用法 that this server could "
        "not understand."
    )
...
class SecurityError(BadRequest):
    ...
    exactly like a bad request高级用法 error.
...
class NotAcceptable(HTTPException):
    ...
    description = (
        "The resource identified by the request高级用法 is only capable of"
        " generating response entities which have content"
        " characteristics not acceptable according to the accept"
        " headers sent in the request高级用法."
    )
...
class RequestTimeout(HTTPException):
    ...
    description = (
        ...
        " didn't finish the request高级用法 within the specified time."
    )
...
class Conflict(HTTPException):
    ...
    Raise to signal that a request高级用法 cannot be completed because it conflicts
    ...
    code = 409
    description = (
        "A conflict happened while processing the request高级用法. The"
        " resource might have been modified while the request高级用法 was being"
        " processed."
    )
...
class LengthRequired(HTTPException):
    ...
    code = 411
    description = (
        "A request高级用法 with this method requires a valid <code>Content-"
        "Length</code> header."
    )
...
class PreconditionFailed(HTTPException):
    ...
    code = 412
    description = (
        "The precondition on the request高级用法 for the URL failed positive evaluation."
    )
...
class RequestURITooLarge(HTTPException):
    ...
    description = (
        ...
        " this server. The request高级用法 cannot be processed."
    )
...
class UnsupportedMediaType(HTTPException):
    ...
    code = 415
    description = (
        "The server does not support the media type transmitted in the request高级用法."
    )
...
class ExpectationFailed(HTTPException):
    ...
    The server cannot meet the requirements of the Expect request高级用法-header.
...
class UnprocessableEntity(HTTPException):
    ...
    Used if the request高级用法 is well formed, but the instructions are otherwise
    incorrect.
    """

    code = 422
    description = (
        "The request高级用法 was well-formed but was unable to be followed due"
        " to semantic errors."
    )
...
class PreconditionRequired(HTTPException):
    ...
    The server requires this request高级用法 to be conditional, typically to prevent
    the lost update problem, which is a race condition between two or more
    clients attempting to update a resource through PUT or DELETE. By requiring
    each client to include a conditional header ("If-Match" or "If-Unmodified-
    Since") with the proper value retained from a recent GET request高级用法, the
    ...
    code = 428
    description = (
        "This request高级用法 is required to be conditional; try using"
...
class TooManyRequests(HTTPException):
    ...
    this request高级用法 exceeds that rate. (The server may use any convenient method
    to identify users and their request高级用法 rates). The server may include a
    "Retry-After" header to indicate how long the user should wait before
    retrying.
    """

    code = 429
    description = "This user has exceeded an allotted request高级用法 count. Try again later."


class RequestHeaderFieldsTooLarge(HTTPException):
    """*431* `Request Header Fields Too Large`

    The server refuses to process the request高级用法 because the header fields are too
...
class InternalServerError(HTTPException):
    ...
    description = (
        ...
        " complete your request高级用法. Either the server is overloaded or"
...
class BadGateway(HTTPException):
    ...
    in attempting to fulfill the request高级用法.
    """
...
class ServiceUnavailable(HTTPException):
    ...
    code = 503
    description = (
        "The server is temporarily unable to service your request高级用法 due"
...
class HTTPVersionNotSupported(HTTPException):
    ...
    The server does not support the HTTP protocol version used in the request高级用法.
    """
...
#: bad request高级用法.  Used by a lot of the datastructures.
