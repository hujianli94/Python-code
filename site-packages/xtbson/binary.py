...
from xtbson.py3compat import PY3, binary_type
...
by :mod:`xtbson` using this subtype.
...
:class:`uuid.UUID` instances will automatically be encoded
by :mod:`xtbson` using :data:`OLD_UUID_SUBTYPE`.
...
class UUIDLegacy(Binary):
    ...
    .. doctest::
      ...
      >>> import uuid
      >>> from xtbson.binary import Binary, UUIDLegacy, UUID_SUBTYPE
      >>> my_uuid = uuid.uuid4()
      >>> coll = db.test
